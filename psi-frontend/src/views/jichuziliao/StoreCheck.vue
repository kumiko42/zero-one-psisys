...
import {queryDepot, queryDepotDetail, removeDepot} from './api/storecheck.js'
import {measurementDelete, measurementGet, measurementGetKid} from "./api/measurementcheck";
